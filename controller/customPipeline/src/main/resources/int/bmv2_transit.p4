control process_int_transit (
    ...
    table tb_int_insert {
        ...
        //Technicaly this is not a match of a packet field, but a match of a header property,
        // so the match has to be true to apply actions. The flowrule/match entry has to be
        // added like: field: int_is_valid, value: 1.
